class Sub_Saturate_s16_u8_s16 : public Kernel<short> {
private:
    Accessor<unsigned char> &input1;
    Accessor<short> &input2;

public:
    Sub_Saturate_s16_u8_s16(IterationSpace<short> &iter, Accessor<unsigned char> &input1, Accessor<short> &input2)
