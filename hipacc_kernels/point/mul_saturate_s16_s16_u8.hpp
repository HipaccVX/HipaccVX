class Mul_Saturate_s16_s16_u8 : public Kernel<short> {
private:
...
public:
    Mul_Saturate_s16_s16_u8(IterationSpace<short> &iter,Accessor<short> &input1, Accessor<unsigned char> &input2, float scale)
