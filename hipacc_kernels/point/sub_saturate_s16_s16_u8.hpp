class Sub_Saturate_s16_s16_u8 : public Kernel<short> {
private:
    Accessor<short> &input1;
    Accessor<unsigned char> &input2;

public:
    Sub_Saturate_s16_s16_u8(IterationSpace<short> &iter, Accessor<short> &input1, Accessor<unsigned char> &input2)
