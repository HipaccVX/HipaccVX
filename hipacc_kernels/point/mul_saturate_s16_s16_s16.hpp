class Mul_Saturate_s16_s16_s16 : public Kernel<short> {
private:
...
public:
    Mul_Saturate_s16_s16_s16(IterationSpace<short> &iter,Accessor<short> &input1, Accessor<short> &input2, float scale)
