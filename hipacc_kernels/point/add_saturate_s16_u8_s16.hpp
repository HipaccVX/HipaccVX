class Add_Saturate_s16_u8_s16 : public Kernel<short> {
private:
    Accessor<unsigned char> &input1;
    Accessor<short> &input2;

public:
    Add_Saturate_s16_u8_s16(IterationSpace<short> &iter, Accessor<unsigned char> &input1, Accessor<short> &input2)
