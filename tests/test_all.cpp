...
*/
  ...
  if (vxGetStatus((vx_reference)context) == VX_SUCCESS) {
	...
	vx_image images[] = {
        ...
        vxCreateImageFromFile(context, WIDTH, HEIGHT, VX_DF_IMAGE_U8,
                              "200x300_bw_2.png"),           /* 43: sample corner input image */
