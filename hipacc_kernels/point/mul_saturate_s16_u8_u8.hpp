class Mul_Saturate_s16_u8_u8 : public Kernel<short> {
private:
...
public:
    Mul_Saturate_s16_u8_u8(IterationSpace<short> &iter,Accessor<unsigned char> &input1, Accessor<unsigned char> &input2, float scale)
